...
import com.network.sdk.BaseFragment;
import com.network.sdk.R;
...
public abstract class GridlayoutListFragment<M, VH extends RecyclerView.ViewHolder, A extends RecyclerView.Adapter<VH>> extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
...
//        return new LinearLayoutManager(getContext(), RecyclerView.VERTICAL, false);
    ...
    public abstract class LoadCallback {
         ...
         * 调用这个方法代表成功获取指定页面的数据。
         * 失败时不需要调用。
         * 这个方法的调用必须在{@link #onResult()}后面，且中间不能插入对{@link GridlayoutListFragment#nextPage()}的调用
         */
